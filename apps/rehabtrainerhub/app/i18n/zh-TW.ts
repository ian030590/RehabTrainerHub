...
export const zhTW = {
  ...
  hubUi: {
    ...
    progress: {
      ...
      daysSinceStart: '距開始復健經過',
      rehabilitationDays: '累計復健天數',
      days: '天',
      startedOn: '開始於 {date}',
      noRecords: '尚無復健紀錄',
    ...
    educationArticles: {
      ...
      reload: '重新載入',
      emptyTitle: '衛教文章準備中',
      emptyBody: '治療師發布文章後，會以卡片形式顯示在這裡。',
      loadMore: '載入更多文章',
      loadingMore: '載入中…',
    ...
    questions: {
      ...
      aboutTitle: '關於這個網站',
      aboutBody: 'Rehab Trainer Hub 是居家復健訓練的整合入口，協助您依需求找到動作、視覺、認知與口腔訓練。登入後可保存訓練紀錄、追蹤每日任務與復健進度，並在不同訓練器之間延續使用體驗。',
      servicesKicker: '訓練服務',
      servicesTitle: '各訓練器網站',
      trainerDescriptions: {
        motor: '上肢動作與手部控制訓練',
        vision: '視覺搜尋、眼球運動與視覺認知訓練',
        brain: '注意力、記憶與高階認知訓練',
        mouth: '口腔與舌部動作訓練',
      },
    },
    privacy: {
      ...
      use: '資料用途',
      useBody: '資料用於跨裝置登入、保存訓練紀錄、計算每日任務與連續復健成就，以及改善訓練服務。',
      permissions: '裝置權限',
