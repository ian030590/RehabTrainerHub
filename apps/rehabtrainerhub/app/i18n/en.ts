...
export const en = {
  ...
  hubUi: {
    navigation: {
      ...
      admin: 'Therapist administration',
    ...
    lobby: {
      ...
      intro: 'Choose a training goal or search by module name.',
    ...
    progress: {
      kicker: 'Rehabilitation progress',
      title: 'Progress',
      ...
      daysSinceStart: 'Days since starting rehabilitation',
      rehabilitationDays: 'Current rehabilitation streak',
      days: 'days',
      startedOn: 'Started on {date}',
      noRecords: 'No rehabilitation records yet',
    ...
    educationArticles: {
      ...
      emptyBody: 'Articles published by therapists will appear here as cards.',
    ...
    questions: {
      ...
      aboutBody: 'Rehab Trainer Hub is a home rehabilitation portal that helps you find motor, vision, cognitive, and oral training based on your needs. After signing in, you can save training records, track daily tasks and rehabilitation progress, and continue smoothly between trainers.',
      servicesKicker: 'Training services',
      servicesTitle: 'Trainer websites',
      trainerDescriptions: {
        motor: 'Upper-limb movement and hand-control training',
        vision: 'Visual search, eye-movement, and visual-cognition training',
        brain: 'Attention, memory, and higher-cognition training',
        mouth: 'Oral and tongue-movement training',
      },
    },
    privacy: {
      ...
      useBody: 'Data is used for cross-device sign-in, saving training records, calculating daily tasks and rehabilitation milestones, and improving training services.',
