...
const seeds: readonly TrainingCatalogSeed[] = [
  ...
  },
  {
    ...
    zh: ['周邊注意力訓練', '以三階段活動練習處理速度、分散注意力與選擇性注意力。'],
    en: ['Peripheral Attention Training', 'Use a three-stage activity to practise processing speed, divided attention, and selective attention.'],
