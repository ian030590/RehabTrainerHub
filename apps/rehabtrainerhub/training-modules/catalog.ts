...
const seeds: readonly TrainingCatalogSeed[] = [
  ...
  },
  {
    ...
    zh: ['UFOV 注意力練習', '以三階段活動練習處理速度、分散注意力與選擇性注意力。'],
    en: ['UFOV Attention Practice', 'Use a three-stage activity to practise processing speed, divided attention, and selective attention.'],
