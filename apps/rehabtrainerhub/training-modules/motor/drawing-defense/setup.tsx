...
>({
  ...
  loadComponent: async () => {
    const [{ DrawingTowerDefenseGame }, { LanguageProvider }] = await Promise.all([
      import('../pages/training/DrawingTowerDefenseGame'),
      import('../i18n'),
    ]);
    return function DrawingDefenseNativeRuntime(props: DrawingTowerDefenseGameProps) {
      return createElement(LanguageProvider, null, createElement(DrawingTowerDefenseGame, props));
    };
  },
