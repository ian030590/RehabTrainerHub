...
>({
  ...
  loadComponent: async () => {
    const [{ AsteroidShieldGame }, { LanguageProvider }] = await Promise.all([
      import('../pages/training/AsteroidShieldGame'),
      import('../i18n'),
    ]);
    return function AsteroidShieldNativeRuntime(props: AsteroidShieldGameProps) {
      return createElement(LanguageProvider, null, createElement(AsteroidShieldGame, props));
    };
  },
