...
import { ToTrainingRunResult } from '../../shared/trainingRunResult';
...
export interface BrainTrainingRecord {
  ...
  /** Compact protocol result retained alongside the module-specific detail rows. */
...
function ToTrainingRecord(value: unknown): BrainTrainingRecord | null {
  ...
  return {
    ...
    detailRows: Array.isArray(item.detailRows)
      ...
      : undefined,
    runResult: ToTrainingRunResult(item.runResult),
  };
}
