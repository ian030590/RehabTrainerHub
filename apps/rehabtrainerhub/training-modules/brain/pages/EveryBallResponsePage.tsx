              ...
              >
                {errorMessage && (
                  canRetryMediaPermission
                    ? (
                      <button
                        className="every-ball-error inline-alert-action"
                        type="button"
                        onClick={() => {
                          setErrorMessage('');
                          mediaPermission.retry();
                        }}
                      >
                        {`${errorMessage} ${retryPermissionLabel}`}
                      </button>
                    )
                    : <div className="every-ball-error" role="alert">{errorMessage}</div>
                )}
              </TrainingConfigNavigationActions>
            )}
          >
