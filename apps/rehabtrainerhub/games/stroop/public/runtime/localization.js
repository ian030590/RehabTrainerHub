window.rehabBilingualize = function () {
      ...
      var chinesePages = ["畫面會逐一出現 RED、BLUE、GREEN 等英文顏色字。請判斷字的墨水顏色，不是字義：紅色按 R、藍色按 B、綠色按 G。例如藍色的 RED 應按 B。請盡量快速且正確作答。"];
      ...
      var specs = [["start_practice_block","text","接下來先進行練習試次。請依文字的墨水顏色按 R、B 或 G，按 Enter 開始。"],["start_test_block","text","練習結束，接下來進入正式試次。作答方式相同，按 Enter 開始。"],["end_block","text","本次作業已完成。按 Enter 查看當次紀錄。"]];
