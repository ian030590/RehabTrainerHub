...
const copy: GameTourCopy = {
  "title": {
    "zh": "眼球運動練習",
    "en": "Oculomotor Training"
  },
  "goal": {
    "zh": "跟隨目標移動，練習平順與準確的眼球運動。",
    "en": "Follow the target and practise smooth, accurate eye movements."
  },
  "stimulus": {
    "zh": "目標會在不同方向與速度間移動。",
    "en": "The target moves in different directions and speeds."
  },
  "response": {
    "zh": "保持視線追蹤目標，不需移動頭部。",
    "en": "Keep your gaze on the target without moving your head."
  }
};
...
export function GameTour({ children }: { children: ReactNode }) {
  ...
  const completionEvent = 'rehab-trainer:game-tour-complete:oculomotor-training';
  ...
  useEffect(() => {
    ...
    const started = StartTour(steps, {
      ...
      storageKey: 'rehab-tour-oculomotor-training',
      labels: {
  ...
  return (
    <div ref={rootRef} data-game-tour="oculomotor-training" inert={!complete || undefined} aria-label={"眼球運動練習 / Oculomotor Training"}>
      {children}
    </div>
  );
}
