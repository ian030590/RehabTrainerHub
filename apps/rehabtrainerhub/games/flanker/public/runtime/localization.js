window.rehabBilingualize = function () {
      ...
      var chinesePages = ["畫面會出現由 f 與 h 組成的五個字母，例如 fffff 或 hhfhh。請只看正中央的字母，按 F 或 H 鍵；例如 ffhff 應按 H。每次作答後會顯示正誤回饋，先從短暫練習開始。"];
      ...
      var specs = [["start_test_block","text","接下來進入正式試次。只判斷中央字母，按 F 或 H 作答，按 Enter 開始。"],["end_block","text","本次作業已完成。按 Enter 查看當次紀錄。"]];
