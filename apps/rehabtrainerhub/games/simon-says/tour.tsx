...
const copy: GameTourCopy = {
  ...
  "goal": {
    "zh": "記住燈號順序並依序重現。",
    "en": "Remember the light sequence and reproduce it in order."
  },
  "stimulus": {
    "zh": "不同顏色或位置的按鈕會依序亮起。",
    "en": "Buttons at different colours or positions light up in sequence."
  },
  "response": {
    "zh": "按下剛才亮起的按鈕，順序不可錯。",
    "en": "Press the buttons in the same order without an error."
  }
};
...
export function GameTour({ children }: { children: ReactNode }) {
  ...
  const completionEvent = 'rehab-trainer:game-tour-complete:simon-says';
  ...
  useEffect(() => {
    ...
    const started = StartTour(steps, {
      ...
      storageKey: 'rehab-tour-simon-says',
      labels: {
  ...
  return (
    <div ref={rootRef} data-game-tour="simon-says" inert={!complete || undefined} aria-label={"Simon Says / Simon Says"}>
      {children}
    </div>
  );
}
