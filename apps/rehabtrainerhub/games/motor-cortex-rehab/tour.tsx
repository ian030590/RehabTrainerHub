...
const copy: GameTourCopy = {
  "title": {
    "zh": "動作皮質練習",
    "en": "Motor Cortex Practice"
  },
  "goal": {
    "zh": "依視覺提示選擇正確動作反應。",
    "en": "Choose the correct motor response for each visual cue."
  },
  "stimulus": {
    "zh": "畫面提示不同方向、手部或肢體動作。",
    "en": "Visual cues indicate different directions, hand, or body actions."
  },
  "response": {
    "zh": "在提示出現後完成對應動作或按鍵。",
    "en": "Perform the matching movement or key response after the cue."
  }
};
...
export function GameTour({ children }: { children: ReactNode }) {
  ...
  const completionEvent = 'rehab-trainer:game-tour-complete:motor-cortex-rehab';
  ...
  useEffect(() => {
    ...
    const started = StartTour(steps, {
      ...
      storageKey: 'rehab-tour-motor-cortex-rehab',
      labels: {
  ...
  return (
    <div ref={rootRef} data-game-tour="motor-cortex-rehab" inert={!complete || undefined} aria-label={"動作皮質練習 / Motor Cortex Practice"}>
      {children}
    </div>
  );
}
