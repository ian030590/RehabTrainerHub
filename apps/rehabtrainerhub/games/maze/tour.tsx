...
const copy: GameTourCopy = {
  ...
  "goal": {
    "zh": "規劃路徑穿過迷宮並避開障礙。",
    "en": "Plan a route through the maze while avoiding obstacles."
  },
  "stimulus": {
    "zh": "迷宮中有起點、終點與不可通行的牆。",
    "en": "The maze contains a start, a goal, and impassable walls."
  },
  "response": {
    "zh": "使用方向鍵或按鈕移動到終點。",
    "en": "Use the direction keys or buttons to reach the goal."
  }
};
...
export function GameTour({ children }: { children: ReactNode }) {
  ...
  const completionEvent = 'rehab-trainer:game-tour-complete:maze';
  ...
  return (
    <div ref={rootRef} data-game-tour="maze" inert={!complete || undefined} aria-label={"迷宮 / Maze"}>
      {children}
    </div>
  );
}
