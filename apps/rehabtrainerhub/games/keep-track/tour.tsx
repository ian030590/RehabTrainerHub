...
const copy: GameTourCopy = {
  ...
  "goal": {
    "zh": "追蹤指定類別中的最後一個項目。",
    "en": "Track the last item shown in each requested category."
  },
  "stimulus": {
    "zh": "多種類別的項目依序快速出現。",
    "en": "Items from multiple categories appear rapidly in sequence."
  },
  "response": {
    "zh": "回想指定類別最後出現的項目並作答。",
    "en": "Recall and answer the last item in each requested category."
  }
};
...
export function GameTour({ children }: { children: ReactNode }) {
  ...
  const completionEvent = 'rehab-trainer:game-tour-complete:keep-track';
  ...
  useEffect(() => {
    ...
    const started = StartTour(steps, {
      ...
      storageKey: 'rehab-tour-keep-track',
      labels: {
  ...
  return (
    <div ref={rootRef} data-game-tour="keep-track" inert={!complete || undefined} aria-label={"類別記憶追蹤 / Keep Track"}>
      {children}
    </div>
  );
}
