window.rehabBilingualize = function () {
      ...
      var chinesePages = ["數字會依序出現。請記住順序，並在每回合結束後，用畫面上的數字鍵盤依原順序輸入。請靠記憶作答，不要抄寫或使用外部工具。結束說明後即開始。"];
      ...
      var specs = [["start_test_block","text","請依原順序回想數字。準備好後按 Enter 開始。"],["start_reverse_block","text","接下來請依相反順序回想數字。準備好後按 Enter 開始。"],["end_block","text","本次作業已完成。按 Enter 查看當次紀錄。"]];
