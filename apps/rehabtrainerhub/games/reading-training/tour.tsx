...
const copy: GameTourCopy = {
  ...
  "goal": {
    "zh": "依序閱讀文字並完成理解或辨識反應。",
    "en": "Read the text in order and complete the comprehension response."
  },
  "stimulus": {
    "zh": "短文或詞句會以指定速度與版面呈現。",
    "en": "Text or phrases appear with a specified pace and layout."
  },
  "response": {
    "zh": "讀完後選擇或輸入最符合內容的答案。",
    "en": "After reading, choose or enter the answer that matches the text."
  }
};
...
export function GameTour({ children }: { children: ReactNode }) {
  ...
  const completionEvent = 'rehab-trainer:game-tour-complete:reading-training';
  ...
  useEffect(() => {
    ...
    const started = StartTour(steps, {
      ...
      storageKey: 'rehab-tour-reading-training',
      labels: {
  ...
  return (
    <div ref={rootRef} data-game-tour="reading-training" inert={!complete || undefined} aria-label={"閱讀練習 / Reading Practice"}>
      {children}
    </div>
  );
}
