...
function GetPixiAppManager(_scope: PixiRuntimeScope): PixiAppManager { return manager; }
...
export function DestroyPixiRuntime(_scope: PixiRuntimeScope): void { manager.destroy(); }
