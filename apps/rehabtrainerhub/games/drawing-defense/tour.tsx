...
const copy: GameTourCopy = {
  "title": {
    "zh": "繪圖塔防",
    "en": "Drawing Tower Defense"
  },
  "goal": {
    "zh": "畫出防線保護目標，並依來襲路徑調整策略。",
    "en": "Draw defenses to protect the target and adapt to incoming paths."
  },
  "stimulus": {
    "zh": "敵人沿路徑移動，畫出的線條會形成防守。",
    "en": "Enemies follow paths while your drawn lines form the defense."
  },
  "response": {
    "zh": "在畫布上拖曳畫線，阻擋或引導敵人。",
    "en": "Drag on the canvas to draw lines that block or guide enemies."
  }
};
...
export function GameTour({ children }: { children: ReactNode }) {
  ...
  const completionEvent = 'rehab-trainer:game-tour-complete:drawing-defense';
  ...
  useEffect(() => {
    ...
    const started = StartTour(steps, {
      ...
      storageKey: 'rehab-tour-drawing-defense',
      labels: {
  ...
  return (
    <div ref={rootRef} data-game-tour="drawing-defense" inert={!complete || undefined} aria-label={"繪圖塔防 / Drawing Tower Defense"}>
      {children}
    </div>
  );
}
