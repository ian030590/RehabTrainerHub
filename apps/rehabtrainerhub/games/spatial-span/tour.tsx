...
const copy: GameTourCopy = {
  ...
  "goal": {
    "zh": "記住方格亮起的空間順序並重現。",
    "en": "Remember the spatial sequence of lit cells and reproduce it."
  },
  "stimulus": {
    "zh": "方格會依序閃亮，位置可能逐回增加。",
    "en": "Cells light up in order and the sequence may grow each round."
  },
  "response": {
    "zh": "按照相同空間順序點選方格。",
    "en": "Click the cells in the same spatial order."
  }
};
...
export function GameTour({ children }: { children: ReactNode }) {
  ...
  const completionEvent = 'rehab-trainer:game-tour-complete:spatial-span';
  ...
  useEffect(() => {
    ...
    const started = StartTour(steps, {
      ...
      storageKey: 'rehab-tour-spatial-span',
      labels: {
  ...
  return (
    <div ref={rootRef} data-game-tour="spatial-span" inert={!complete || undefined} aria-label={"空間廣度記憶 / Spatial Span"}>
      {children}
    </div>
  );
}
