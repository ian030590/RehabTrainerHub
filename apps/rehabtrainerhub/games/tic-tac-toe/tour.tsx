...
const copy: GameTourCopy = {
  ...
  "goal": {
    "zh": "輪流放置符號，先連成三格即可獲勝。",
    "en": "Take turns placing symbols; connect three to win."
  },
  "stimulus": {
    "zh": "三乘三棋盤顯示尚未佔用的格子。",
    "en": "A three-by-three board shows the unoccupied cells."
  },
  "response": {
    "zh": "選擇空格放置自己的符號並阻擋對手。",
    "en": "Choose an open cell and block the opponent."
  }
};
...
export function GameTour({ children }: { children: ReactNode }) {
  ...
  const completionEvent = 'rehab-trainer:game-tour-complete:tic-tac-toe';
  ...
  useEffect(() => {
    ...
    const started = StartTour(steps, {
      ...
      storageKey: 'rehab-tour-tic-tac-toe',
      labels: {
  ...
  return (
    <div ref={rootRef} data-game-tour="tic-tac-toe" inert={!complete || undefined} aria-label={"圈圈叉叉 / Tic-Tac-Toe"}>
      {children}
    </div>
  );
}
