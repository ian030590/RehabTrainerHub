...
function GetRuleSections(gameId: string, lang: 'zh' | 'en') {
    ...
    switch (gameId) {
        case 'tic-tac-toe':
            return BuildRules(isZh, '與電腦輪流下棋，先連線者獲勝。', 'Take turns against the computer and make a line first.', ['你是 X。', '點擊空格落子，電腦會自動回合。'], ['You are X.', 'Tap an empty cell; the computer moves automatically.']);
        default:
