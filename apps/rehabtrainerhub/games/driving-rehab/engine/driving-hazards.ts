// Hazard definitions local to the Hub-owned driving runtime.
import type { DifficultyPreset, HazardTemplate } from '../types/types';

export const difficultyPresets: Record<string, DifficultyPreset> = {
