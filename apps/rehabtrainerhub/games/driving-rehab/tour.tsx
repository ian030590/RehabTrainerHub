...
const copy: GameTourCopy = {
  "title": {
    "zh": "駕駛反應練習",
    "en": "Driving Response Practice"
  },
  "goal": {
    "zh": "掃視道路資訊，在安全時機做出駕駛反應。",
    "en": "Scan road information and make the driving response at a safe moment."
  },
  "stimulus": {
    "zh": "道路、車輛或號誌會在視野中出現並改變。",
    "en": "Road, vehicle, or signal events appear and change in the scene."
  },
  "response": {
    "zh": "依照畫面事件按下對應方向或煞車反應。",
    "en": "Use the matching direction or brake response for each event."
  }
};
...
export function GameTour({ children }: { children: ReactNode }) {
  ...
  const completionEvent = 'rehab-trainer:game-tour-complete:driving-rehab';
  ...
  useEffect(() => {
    ...
    const started = StartTour(steps, {
      ...
      storageKey: 'rehab-tour-driving-rehab',
      labels: {
  ...
  return (
    <div ref={rootRef} data-game-tour="driving-rehab" inert={!complete || undefined} aria-label={"駕駛反應練習 / Driving Response Practice"}>
      {children}
    </div>
  );
}
