...
const copy: GameTourCopy = {
  ...
  "goal": {
    "zh": "連接棋盤兩側，建立不中斷的路徑。",
    "en": "Connect your two board edges with an unbroken path."
  },
  "stimulus": {
    "zh": "六角格棋盤會顯示可落子的空格。",
    "en": "A hexagonal board shows the open cells available for play."
  },
  "response": {
    "zh": "選擇空格放置棋子，阻斷對手連線。",
    "en": "Choose an open cell, place a stone, and block the opponent."
  }
};
...
export function GameTour({ children }: { children: ReactNode }) {
  ...
  const completionEvent = 'rehab-trainer:game-tour-complete:hex';
  ...
  return (
    <div ref={rootRef} data-game-tour="hex" inert={!complete || undefined} aria-label={"六角棋 / Hex"}>
      {children}
    </div>
  );
}
