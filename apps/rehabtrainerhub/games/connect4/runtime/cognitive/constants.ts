...
export const referenceCognitiveModules: ReferenceModuleMeta[] = [{ "id": "connect4", "titleKey": "cognitive.connect4.title", "referenceTitleKey": "cognitive.connect4.referenceTitle", "descriptionKey": "cognitive.connect4.desc", "focusKey": "cognitive.connect4.focus" }];
