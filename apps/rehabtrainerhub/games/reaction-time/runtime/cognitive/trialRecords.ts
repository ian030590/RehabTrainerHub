import type { ReactionTrialOutcome,ReactionTrialRecord,TargetTrialOutcome,TargetTrialRecord } from './types';
...
export function CreateReactionTrialRecord(trialNumber: number, outcome: ReactionTrialOutcome, startMs: number | null, endMs: number): ReactionTrialRecord {
    return {
        trialNumber,
        outcome,
