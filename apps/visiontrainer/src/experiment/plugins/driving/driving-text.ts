...
export const DRIVING_TEXT = {
  zh: {
    ...
    navTurn: '導航：{dist}m 後{instruction} {arrow}',
    navStraight: '導航：直行前往終點',
    timeUp: '時間已到',
  ...
  en: {
    ...
    navTurn: 'Navigation: {instruction} in {dist}m {arrow}',
    navStraight: 'Navigation: continue to destination',
    timeUp: 'TIME UP',
