...
const text = {
  zhTW: {
    ...
    profileNeeded: '可完成基本資料與醫療史問卷，讓登入後的訓練紀錄用於分組分析與網站改善。',
    ...
    profileIntro: '這些資料會和登入後的訓練紀錄一起保存，用於分組分析與改善網站。你可以稍後再補填。',
    basicQuestionnaire: '基本資料問卷',
    medicalQuestionnaire: '醫療史問卷',
    medicalIntro: '請只填寫已知且正確的資料；慢性病只勾選醫師已診斷的狀況。本站不會依填寫內容提供個別評估、診斷或治療。',
    ageRange: '年齡',
    gender: '性別',
    nationality: '國籍',
  ...
  en: {
    ...
    profileNeeded: 'You can complete the basic profile and medical history questionnaires so signed-in training records support grouped analysis and website improvement.',
    ...
    profileIntro: 'These fields are saved with signed-in training records for grouped analysis and website improvement. You can fill them in later.',
    basicQuestionnaire: 'Basic Profile Questionnaire',
    medicalQuestionnaire: 'Medical History Questionnaire',
    medicalIntro: 'Provide only known and accurate information. Select chronic conditions only when diagnosed by a physician. This site does not provide individualized assessment, diagnosis, or treatment based on these answers.',
    ageRange: 'Age',
    gender: 'Gender',
