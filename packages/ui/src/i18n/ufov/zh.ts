...
export const ufovZhCopy: UfovCopy = {
  title: 'UFOV 注意力練習',
...
export const ufovZhConfigLabels: UfovConfigLabels = {
...
export function GetUfovZhRuleSections(subtestTitle: string): UfovRuleSection[] {
  return [
    {
      title: '任務目標',
